...
def firstDraftWithTypo(drafts):
    # Your code here
    #use binary search similar to the rotation problem
    ...
    while left < right:
        ...
        if containsTypo(mid):
            ...
            #but not the mid draft as it can be the draft witht he typo
            right = mid
...
drafts = ['home', 'home', 'hume', 'hume']

print(firstDraftWithTypo(drafts))